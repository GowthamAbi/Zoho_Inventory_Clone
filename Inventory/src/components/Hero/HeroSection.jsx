  ...
  return (
    <section>
        <div className='flex mx-auto max-w-2xl flex-col px-8 py-8 md:py-16'>
          ...
          <button className=' border border-red-500 hover:bg--600 text-red-600 hover:bg-[color-mix(in_srgb,var(--primary)_80%,white)] cursor-pointer rounded-lg  px-6 py-2  font-bold '>EXPLORE DEMO ACCOUNT</button>
          </div>
        </div>
        <Feature/>
    </section>
